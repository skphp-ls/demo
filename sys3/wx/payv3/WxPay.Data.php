...
* 企业向个人转款
*/
class WxPayMch extends WxPayDataBase
{
	public function mchAppid($value)
	{
	...
	public function checkNameNo()
	{
		$this->values['check_name'] = 'NO_CHECK';
	}

	public function checkNameYes($value)
	{
		$this->values['check_name'] = 'FORCE_CHECK';
...
class WxPayResults extends WxPayDataBase
{
	...
	public static function InitMch($xml)
	{	
		$obj = new self();
		$obj->FromXml($xml);
		//fix bug 2015-06-29
