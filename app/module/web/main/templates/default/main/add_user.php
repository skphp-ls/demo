...
<div class="modal-body">			
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="truename" class="form-control w300 input-lg">
			</div>
		</div>			
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="phone" class="form-control w300 input-lg">
			</div>
		</div>	
		<div class="form-group">
			<label class="col-sm-2 control-label">发货地址</label>
			<div class="col-sm-10">
				<input type="text" name="address" class="form-control w300 input-lg">
			</div>
		</div>				
